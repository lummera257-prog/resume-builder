...
export default function Skills() {
  ...
  const totalSkills = items.reduce((a, s) => a + (s.items?.length || 0), 0)
  ...
  return (
    <SectionCard
      ...
      badge={items.length > 0 ? `${totalSkills} skills` : undefined}
    >

      <p className="text-xs text-slate-400 mb-3">
        Group skills by category. Use commas to separate skills.
      </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-3 pr-10">
            ...
            <Field
              ...
              hint="e.g. React, TypeScript, Node.js, AWS"
            >
              <TextInput
