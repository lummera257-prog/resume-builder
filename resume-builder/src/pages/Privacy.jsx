...
export default function Privacy() {
  ...
  const sections = [
    { icon: "🔒", title: "Information We Do NOT Collect", content: "ResumeForge does not collect, store, or transmit any personal information you enter while building your resume. All resume content is processed entirely within your browser and stays on your device." },
    ...
    { icon: "🔗", title: "Third-Party Services", content: "We use Vercel to host this site and to run Vercel Analytics and Speed Insights (see Analytics & Advertising above). The Android version of ResumeForge is distributed through Google Play. We do not send your resume content to any of these services. Our platform may link to or integrate with third-party tools. We are not responsible for the privacy practices of those services. We encourage you to review their privacy policies before interacting with them." },
