    ...
    <header className="sticky top-0 z-50 bg-white border-b border-slate-200">
      <div className="flex items-center gap-3 px-4 h-14 max-w-screen-2xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-1 ml-2">
          <Link to="/about" className="text-sm text-slate-600 hover:text-slate-900 px-3 py-1.5 rounded-lg hover:bg-slate-100">
            About
          </Link>
          <Link to="/contact" className="text-sm text-slate-600 hover:text-slate-900 px-3 py-1.5 rounded-lg hover:bg-slate-100">
            Contact
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={loadSample}
            className="hidden sm:flex items-center gap-1 text-xs px-3 py-1.5 bg-slate-100 rounded-lg hover:bg-slate-200"
          >
            <Sparkles size={13} />
          ...
          {showConfirm ? (
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1 text-xs px-3 py-1.5 hover:bg-slate-100 rounded-lg"
            >
              <RotateCcw size={13} />
          ...
          <button
            ...
            disabled={exporting}
            className="flex items-center gap-1 text-sm px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-70"
          >
