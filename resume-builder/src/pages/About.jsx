...
export default function About() {
  useEffect(() => {
    document.title = "About Us | ResumeForge - Free ATS Resume Builder";
    ...
    meta.setAttribute(
      "content",
      "Learn about ResumeForge — a free, ATS-friendly resume builder for students, freshers, and professionals. No login required."
    );
  }, []);
      ...
      >
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              ResumeForge helps students, freshers, and professionals create
              ATS-friendly resumes in minutes — completely free.
            </p>
          </div>
        </div>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto", padding: "0 24px 60px" }}>
          ...
          >
            <p style={{ color: "#374151", fontSize: "1rem", lineHeight: 1.8, margin: "0 0 14px" }}>
              👋 Welcome to <strong>ResumeForge</strong> — your trusted platform to create
              professional, ATS-friendly resumes in minutes, completely free.
            </p>
            <p style={{ color: "#6b7280", fontSize: "0.95rem", lineHeight: 1.8, margin: 0 }}>
              Our mission is simple: make resume building <strong>easy, fast, and free</strong> — so
              you can focus on landing the job, not formatting a document.
            </p>
          </div>
          ...
          >
            {stats.map((stat, i) => (
              ...
              >
                ...
                <div style={{ fontSize: "1.4rem", fontWeight: 800, color: "#2563eb", lineHeight: 1 }}>
                  {stat.value}
                </div>
          ...
          >
            {features.map((f, i) => (
              ...
              >
                ...
                <h3 style={{ fontSize: "0.95rem", fontWeight: 700, color: "#1e3a5f", margin: "0 0 8px" }}>
                  {f.title}
                </h3>
          ...
          >
            ...
            <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "0.95rem", margin: "0 0 20px", lineHeight: 1.7 }}>
              ResumeForge is a passion project built to help people succeed in their careers.
              We update our templates and features regularly based on your feedback.
            </p>
